...
const Reclamation = props => (
  ...
  <Button color="danger" type="button"   
          size={'sm'}
        >  <a href={`http://localhost:3000/admin/ReclamationDetails/${props.reclamation._id}`}> 
        details </a> 
 </Button>
 </td>
...
//endwhats
   ...
   if (etat == 'treated') this.deapprouveReclamation(id);
    ...
    detailReclamation(id) {
      axios.get('http://localhost:5000/reclamation/'+id)
        .then(response => { console.log(response.data)});
      ...
      return this.state.reclamations.map(currentreclamation => {
        return <Reclamation reclamation={currentreclamation}
         ...
         handleChangeapp={this.handleChangeapp}
          ...
          detailReclamation={this.detailReclamation}
