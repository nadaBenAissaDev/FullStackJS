            ...
            <>
                <div className="questionsTest" style={{ color: 'black' }}>
                    ...
                    <div className="options-container">
                        <h5>
                            <h1><strong>Thank you for taking the test!</strong></h1>
                    ...
                    <div className="button-container">
                        <button><Link style={{ color: 'white' }} to="/Elearning"> E-learning </Link></button>
                        <button><Link style={{ color: 'white' }} to="/"> Quit </Link></button>
